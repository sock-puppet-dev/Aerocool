...
h1: ""          # необязательно
description: "Развернутый FAQ Aerocool: ответы о сериях SKY, WING и XTAL, материалах, 7D, 8D, 11D, synchronous tilt, гарантии, доставке и подборе кресла под работу, home office и гейминг."
...
faq:
  - question: "Aerocool.ua — это официальный сайт бренда в Украине?"
    answer: "Да. Aerocool.ua позиционируется как официальный сайт Aerocool в Украине, где собраны актуальные серии SKY, WING и XTAL, а также гайды, FAQ, новости и контакты бренда."
  - question: "Чем отличаются серии SKY, WING и XTAL?"
    answer: "SKY лучше всего подходит для ежедневной работы и home office, WING — для более активной поддержки спины и 11D регулировки, XTAL — для тех, кому важны balanced-платформа, synchronous tilt и конструкция со сменными элементами."
...
Для FAQ-страницы в текущем проекте важно не только заполнить `faq:` во front matter, но и сделать полноценный видимый FAQ в теле страницы:

- сначала короткий лид без `# H1`;
- затем видимые вопросы и ответы в markdown;
- затем блок внутренних ссылок на каталог, серии, статьи и контакты.

Если на FAQ-странице используется длинный формат на `20-30` вопросов, он должен оставаться:
