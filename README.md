...
Последний полный аудит документации, синхронизации с кодом и официальными практиками 2026 года находится в [docs/audits/90-2026-06-24-full-documentation-project-sync-audit-after-87-89.md](docs/audits/90-2026-06-24-full-documentation-project-sync-audit-after-87-89.md). Итоговая оценка после исправлений: **9.8/10**. Документы `87` и `88` добавлены как профильные документы по расширению ключевых слов, контента и стратегии роста; аудит `89` добавлен как профильная проверка `image` + `cover`, размеров, форматов, crop-наборов и дублей главных товарных изображений. Аудиты `78`, `82` и `86` остаются историческими снимками.
