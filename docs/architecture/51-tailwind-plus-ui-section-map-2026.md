...
| Alerts | Success/error/info-состояния визуально отличаются от обычного текста. | Без JS минимум оформить success page как alert с accent border; browser validation оставить для ошибок полей. |
