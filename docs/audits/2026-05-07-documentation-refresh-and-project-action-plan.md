...
### P0.3. Local Organization, Address И Размещение `sameAs`

Status `2026-05-07`: подтверждено пользователем проекта. Адрес, телефон, support/sales email и часы работы считаются актуальными публичными business facts для `Aerocool Ukraine`.
...
Status `2026-05-07`: source of truth, owner и `priceValidUntil` зафиксированы. Владелец бизнес-значений — команда Aerocool Украина; техническая точка внесения — product front matter в `content/products/**/index*.md`; `priceValidUntil: 2027-12-31` подтвержден как актуальный срок действия товарных цен.
...
3. Done `2026-05-07`: `priceValidUntil: 2027-12-31` подтвержден командой Aerocool Украина.
...
Status `2026-05-07`: initial entity registry создан в [entity-registry-2026.md](/Users/stadnyk/MEGA/Aerocool/docs/seo/entity-registry-2026.md), beginner-гайд добавлен в [entity-registry-beginner-guide-2026.md](/Users/stadnyk/MEGA/Aerocool/docs/seo/entity-registry-beginner-guide-2026.md), структурированный слой добавлен в [data/entities.yaml](/Users/stadnyk/MEGA/Aerocool/data/entities.yaml), а safe resolver подключен к schema partials. Пункт “нет entity registry” закрыт на уровне документации, шаблонной инфраструктуры и priority content.
...
- [docs/seo/entity-registry-2026.md](/Users/stadnyk/MEGA/Aerocool/docs/seo/entity-registry-2026.md)
...
Status `2026-05-07`: template support для `about_entities`, `mentions_entities` и `product_group_id` добавлена. Priority pages заполнены точечно: home, about, contact, FAQ, hubs, series, articles, news and product pages. Массово для будущего контента поля не добавлять; сначала использовать registry и visible content QA.
...
2. Done `2026-05-07`: local organization facts и размещение глобальных `sameAs` подтверждены.
3. Done `2026-05-07`: source of truth и owner для product facts зафиксированы.
...
1. Done `2026-05-07`: initial entity registry создан.
2. Done `2026-05-07`: entity homes для серий, материалов, механизмов, сценариев и policy entities зафиксированы.
3. Done `2026-05-07`: `about_entities`, `mentions_entities` и `product_group_id` спроектированы и подключены к safe resolver.
4. Done `2026-05-07`: `docs/content/front-matter-reference.md` обновлен.
...
3. Done `2026-05-07`: priority pages получили `about_entities`, `mentions_entities` и staged `product_group_id`; дальше поддерживать это правило для новых страниц.
