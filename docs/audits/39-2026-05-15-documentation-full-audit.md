...
- документация хорошо покрывает Hugo 0.161.0, Node 24, Tailwind CSS 4, Netlify, PageSpeed quality workflow, SEO, schema.org, entity registry, AI Search и Core Web Vitals;
