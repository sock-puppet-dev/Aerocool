...
1. Выполнить актуальный алгоритм review-системы из [netlify-database-reviews.md](/Users/stadnyk/MEGA/Aerocool/docs/deploy/netlify-database-reviews.md): миграция `reviews`, тестовый товар, `POST /api/reviews`, moderation endpoint, build-time export и Hugo review block.
