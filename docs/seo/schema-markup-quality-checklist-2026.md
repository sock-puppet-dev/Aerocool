...
Правило поддержки: если меняется видимый коммерческий факт, одновременно проверить front matter, product schema partial, FAQ и контент страницы.
