...
Этот документ фиксирует стратегию по ключевым словам для всего проекта `Aerocool` и распределение поисковых кластеров по страницам сайта. Рабочая CSV-база находится в [53-keyword-database-2026.md](53-keyword-database-2026.md), отдельный план развития семантического ядра на 2026 год — в [72-semantic-core-keyword-strategy-2026.md](72-semantic-core-keyword-strategy-2026.md), правила расширения контента под новые ключи — в [87-content-expansion-keyword-roadmap-2026.md](87-content-expansion-keyword-roadmap-2026.md), а операционная Top-1 growth system — в [88-semantic-core-top1-growth-system-2026.md](88-semantic-core-top1-growth-system-2026.md).
