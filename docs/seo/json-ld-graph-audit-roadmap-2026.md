...
Status `2026-05-17`: источник рейтингов должен быть не front matter, а approved reviews snapshot из `Netlify Database`. Документ внедрения: [netlify-database-reviews.md](/Users/stadnyk/MEGA/Aerocool/docs/deploy/netlify-database-reviews.md).
