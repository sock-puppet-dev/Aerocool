...
2. Синхронизировать UI и JSON-LD для цены, наличия, гарантии, доставки и возврата.
3. Внедрить SEO-first review pipeline на `Netlify Database` и переключить `Product.aggregateRating` на approved reviews snapshot.
...
9. Вести entity/schema изменения через [20-schema-markup-quality-checklist-2026.md](/Users/stadnyk/MEGA/Aerocool/docs/seo/20-schema-markup-quality-checklist-2026.md), [24-entities-knowledge-graph-playbook-2026.md](/Users/stadnyk/MEGA/Aerocool/docs/seo/24-entities-knowledge-graph-playbook-2026.md) и [21-ecommerce-structured-data-playbook-2026.md](/Users/stadnyk/MEGA/Aerocool/docs/seo/21-ecommerce-structured-data-playbook-2026.md).
