...
3. Проверить готовые группы вариантов после добавления swatches-навигации.
4. Перевести готовые ProductGroup entities в `confirmed` и включить `ProductGroup` / `isVariantOf`.
5. Спроектировать `additionalProperty` из видимых характеристик.
6. Завести регулярный Entity Performance Report.
7. После production-перехода контролировать approved reviews snapshot, GSC product reports и rich-results eligibility на published URL.
